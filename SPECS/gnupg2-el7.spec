...
%global gnupg2_ver 2.2.20
%global libgpg_error_ver 1.45
%global npth_ver 1.6
%global libgcrypt_ver 1.8.9
%global libassuan_ver 2.5.5
%global libksba_ver 1.6.3
...
Source0:   https://gnupg.org/ftp/gcrypt/gnupg/gnupg-%{gnupg2_ver}.tar.bz2
Source10:  https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-%{libgpg_error_ver}.tar.bz2
Source11:  https://gnupg.org/ftp/gcrypt/npth/npth-%{npth_ver}.tar.bz2
Source12:  https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-%{libgcrypt_ver}.tar.bz2
Source13:  https://gnupg.org/ftp/gcrypt/libassuan/libassuan-%{libassuan_ver}.tar.bz2
Source14:  https://gnupg.org/ftp/gcrypt/libksba/libksba-%{libksba_ver}.tar.bz2
...
# NOTICE: following building requirements are INCOMPLETE !
BuildRequires: ncurses-static zlib-static glibc-static readline-static libusb-static gcc-c++ curl-devel gnutls-devel sqlite-devel openldap-devel
...
# no suitable sqlite3 static library, so just disable it
%configure \
...
%changelog
* Tue Jan 03 2023 Casper <hiCasper@users.noreply.github.com> - 2.2.20-1
- Backport CentOS/RHEL 7
...
- Rebuilt for Fedora 23 Change
  https://fedoraproject.org/wiki/Changes/Harden_all_packages_with_position-independent_code* Wed Feb 18 2015 Tomáš Mráz <tmraz@redhat.com> - 2.1.2-1
